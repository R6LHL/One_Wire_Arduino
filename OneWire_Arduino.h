...
#define __ONEWIRE_H__
	...
	#error ARDUINO_BOARD not defined. Please write yor Arduino board with 'define' directive. For example 'AduinoNano328P'.
#endif

#if ARDUINO_BOARD == AduinoNano328P
...
template <unsigned char T_PIN, unsigned char T_DEV_QUAN>
class OneWire
{
//variables
public:
